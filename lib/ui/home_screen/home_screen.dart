            ...
            return Padding(
              ...
              child: Column(
                children: [
                  GestureDetector(
                    onTap: () async {
                      await AppRoutes.push(context, const EditProfileUI());
                    },
                    child: Row(
                      children: [
                        if (data.image != null)
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      await AppRoutes.makeFirst(context, const LoginScreen());
                    },
                    child: Row(
                      children: [
                        Icon(
                        ...
                        Text(
                          S.logout,
                          style:
                              AppText.b2!.cl(AppColors.darkRed).w(6).notoSans(),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: FutureBuilder(
                      ...
                      builder:
                          (final context, final snapshot) => Text(
                            ...
                            style: AppText.b3!.cl(AppColors.grey500).notoSans(),
                          ),
                    ),
                  ),
                ],
    ...
    body: AppColumn(
      ...
      children: [
        FutureBuilder<List<PhotosModel>>(
          future: Future(() async => ApiProvider().getPhotos()),
              ...
              if (snapshot.data != null) {
                ...
                return SizedBox(
                  ...
                  child: PageView.builder(
                    itemBuilder:
                        (final context, final index) => AppImage(
        ...
        FutureBuilder<List<EventUsersModel>>(
          future: Future(() async => ApiProvider().getEventUsers()),
          builder: (final context, final snapshot) {
            if (snapshot.hasData) {
              if (snapshot.data != null) {
        ...
        FutureBuilder<List<PostsModel>>(
          future: Future(() async => ApiProvider().getPosts()),
          builder: (final context, final snapshot) {
            if (snapshot.hasData) {
              if (snapshot.data != null) {
                return Container(
